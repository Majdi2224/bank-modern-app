...
import { discount, robot } from '../assets'; // Ensure this path is correct
import GetStarted from './GetStarted'; // Ensure correct import path
    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          ...
          {/* Ensure GetStarted is shown in the flex container */}
          <div className={`flex-none md:flex md:justify-center md:items-center ${styles.flexCenter} ss:flex hidden md:mr-4 mr-0`}>
        <GetStarted />
      </div>
        </div>
